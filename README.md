...
Momoka Craft Launcher（简称 MCL）是基于 [PCL 社区版](https://github.com/PCL-Community/PCL-CE)（PCL CE）二次开发的版本，主要在视觉与交互体验上进行调整，未对核心功能做大幅改动。
...
Momoka Craft Launcher 是一个基于 PCL 社区版的二次开发版本，与原版 PCL 作者龙腾猫跃无直接隶属关系。
