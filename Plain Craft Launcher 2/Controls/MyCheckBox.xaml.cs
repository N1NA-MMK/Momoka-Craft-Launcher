...
public partial class MyCheckBox
{
    ...
    private void Checkbox_MouseDown()
    {
        ...
        mouseDowned = true;
        Focus();
        ModAnimation.AniStart(ModAnimation.AaColor(ShapeBorder, Border.BackgroundProperty, "ColorBrushBg1", 150,
        ...
        {
            ModAnimation.AaScale(ShapeBorder, 16.5d - ShapeBorder.Width, 180,
                ease: new ModAnimation.AniEaseAppleSpring(1.0d, 0.32d), absolute: true)
        };
        if (Checked == true)
            scaleAnims.Add(ModAnimation.AaScaleTransform(ShapeCheck,
                0.9d - ((ScaleTransform)ShapeCheck.RenderTransform).ScaleX, 180,
