...
public partial class PageSetupUpdate
{
    ...
    private void Init()
    {
        ...
        TextCurrentVersion.Text = "MCL " + VersionNameFormat(ModBase.versionBaseName);
        ModAnimation.AniControlEnabled -= 1;
        CheckUpdate();
    }
        ...
        switch (await IsLatestAsync())
        {
            case UpdateStatus.Available:
            {
                ...
                try
                {
                    ...
                    TextUpdateName.Text = "MCL " + VersionNameFormat(updateInfo.VersionName);
    ...
    {
        ModBase.OpenWebsite("https://github.com/N1NA-MMK/Momoka-Craft-Launcher/releases/v" + ModBase.versionBaseName);
    }
