...
public static partial class Config
{
    ...
    [ConfigGroup("System")] partial class SystemConfigGroup
    {
        ...
        /// <summary>
        /// 减少动画（Reduced Motion）。开启后弹簧/位移降级为短促的淡入淡出，便于对动效敏感的用户。
        /// </summary>
        [ConfigItem<bool>("UiReducedMotion", false, ConfigSource.Local)] public partial bool ReducedMotion { get; set; }
    }
    ...
    [ConfigGroup("Preference")] partial class PreferenceConfigGroup
    {
        ...
        [ConfigGroup("Theme")] partial class ThemeConfigGroup
        {
            ...
            /// 暗色配色主题。
            /// </summary>
            [ConfigItem<ColorTheme>("UiDarkColor", ColorTheme.PinkBlue)] public partial ColorTheme DarkColor { get; set; }

            /// <summary>
            /// 亮色配色主题。
            /// </summary>
            [ConfigItem<ColorTheme>("UiLightColor", ColorTheme.PinkBlue)] public partial ColorTheme LightColor { get; set; }
            ...
            /// <summary>
            /// 自定义主题：色相 (H)。默认偏天蓝（接近 #66CCFF 的色调）。
            /// </summary>
            [ConfigItem<int>("UiLauncherHue", 205, ConfigSource.Local)] public partial int WindowHue { get; set; }

            /// <summary>
            /// 自定义主题：饱和度 (S)。
            /// </summary>
            [ConfigItem<int>("UiLauncherSat", 75, ConfigSource.Local)] public partial int WindowSat { get; set; }

            /// <summary>
            /// 自定义主题：明度 (L)。默认偏亮，避免底色过暗看着别扭。
            /// </summary>
            [ConfigItem<int>("UiLauncherLight", 48, ConfigSource.Local)] public partial int WindowLight { get; set; }
        ...
        [ConfigGroup("Blur")] partial class BlurConfigGroup
        {
            ...
            /// 玻璃色调（背景不透明度，0-100）。
            /// </summary>
            [ConfigItem<int>("UiGlassTint", 80, ConfigSource.Local)] public partial int GlassTint { get; set; }

            /// <summary>
            /// 玻璃阴影半径。
            /// </summary>
            [ConfigItem<int>("UiGlassShadowRadius", 16, ConfigSource.Local)] public partial int GlassShadowRadius { get; set; }

            /// <summary>
            /// 玻璃阴影不透明度（0-100）。
            /// </summary>
            [ConfigItem<int>("UiGlassShadowOpacity", 18, ConfigSource.Local)] public partial int GlassShadowOpacity { get; set; }

            /// <summary>
            /// 镜面高光强度（0-100）。
            /// </summary>
            [ConfigItem<int>("UiGlassSpecular", 100, ConfigSource.Local)] public partial int GlassSpecular { get; set; }

            /// <summary>
            /// 边缘高光强度（0-100）。
            /// </summary>
            [ConfigItem<int>("UiGlassEdge", 100, ConfigSource.Local)] public partial int GlassEdge { get; set; }
        }

        /// <summary>
        /// UI 形态（圆角/密度/边框等可自定义外观参数）。
        /// </summary>
        [ConfigGroup("Shape")] partial class ShapeConfigGroup
        {
            /// <summary>
            /// 圆角风格。
            /// </summary>
            [ConfigItem<CornerStyle>("UiCornerStyle", CornerStyle.Medium, ConfigSource.Local)] public partial CornerStyle CornerStyle { get; set; }

            /// <summary>
            /// 界面密度。
            /// </summary>
            [ConfigItem<UiDensity>("UiDensity", UiDensity.Standard, ConfigSource.Local)] public partial UiDensity Density { get; set; }

            /// <summary>
            /// 边框风格。
            /// </summary>
            [ConfigItem<BorderStyle>("UiBorderStyle", BorderStyle.Standard, ConfigSource.Local)] public partial BorderStyle BorderStyle { get; set; }

            /// <summary>
            /// 是否启用控件阴影（扁平化开关）。
            /// </summary>
            [ConfigItem<bool>("UiShadow", true, ConfigSource.Local)] public partial bool ShadowEnabled { get; set; }
        }
